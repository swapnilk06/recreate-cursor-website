# Recreate - Dev Tool Landing Page - Cursor

<small>[Date : 07-02-26]</small>

This project is a **desktop-first developer tool landing page** inspired by the Cursor website.
...
![alt text](Screenshots/cursor-recreate-but-not-perfect.png)
